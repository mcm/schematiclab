...
const tagCases: TagCase[] = [
  ...
  { name: "snbt_short_2", snbtValue: "-27183S", tagValue: new nbt.Short(-27183) },
  { name: "snbt_integer", snbtValue: "31415926", tagValue: new nbt.Int(31415926) },
  { name: "snbt_long", snbtValue: "31415926L", tagValue: new nbt.Long(31415926n) },
  { name: "snbt_float", snbtValue: "3.1415926F", tagValue: new nbt.Float(3.1415926) },
  {
    name: "snbt_double",
    snbtValue: "3.1415926",
  ...
  },
  {
    ...
    tagValue: new nbt.NbtList([new nbt.Double(3.2), new nbt.Double(64.5), new nbt.Double(129.5)]),
  },
  {
    name: "snbt_compound",
    snbtValue: "{X:3,Y:64,Z:129}",
    tagValue: new nbt.Compound({ X: new nbt.Int(3), Y: new nbt.Int(64), Z: new nbt.Int(129) }),
  },
  {
...
describe("toSnbt", () => {
  it.each(tagCases)("serializes $name", ({ snbtValue, tagValue, serializedValue }) => {
...
const stringCases = [
  {
    ...
    tagValue: new nbt.Compound({
      Pos: new nbt.NbtList([new nbt.Double(1.0), new nbt.Double(2.0), new nbt.Double(3.0)]),
...
describe("SNBT string round-trips", () => {
  it.each(stringCases)("serializes $snbtStr", ({ tagValue, serializedValue, snbtStr }) => {
